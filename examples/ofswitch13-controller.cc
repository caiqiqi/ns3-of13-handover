...
/*
Echo request and reply messages are required 
to maintain connectivity to the controller.
向switch发送Echo Request 消息
*/
int
...
/*
将Barrier Request消息发给switch，这样switch就知道要干活了
*/
int
...
/*
处理从switch发给controller的 Echo Request 消息
*/
ofl_err
...
/*
处理从switch发给controller的 Echo Reply 消息
*/
ofl_err
